...
const FiltersVacanciesScreen = ({ navigation, route }) => {
  ...
  const apply = () => {
    ...
    navigation.navigate('Home', { vacancyFilters: filters });
  };
  ...
  const reset = () => {
    ...
    setEmploymentType('');
    setWorkFormat('');
    navigation.navigate('Home', { vacancyFilters: {} });
  };
...
export default FiltersVacanciesScreen;
